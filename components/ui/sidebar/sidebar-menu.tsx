...
const SIDEBAR_MENU_SUB_BUTTON_SIZES = {
  sm: "sm",
  md: "md",
} as const

type SidebarMenuSubButtonSize =
  (typeof SIDEBAR_MENU_SUB_BUTTON_SIZES)[keyof typeof SIDEBAR_MENU_SUB_BUTTON_SIZES]

export function SidebarMenuSubButton({
  render,
  size = SIDEBAR_MENU_SUB_BUTTON_SIZES.md,
  isActive = false,
  className,
  ...props
