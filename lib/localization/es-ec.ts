...
export const TOAST_MESSAGES = {
  ...
  STUDENT_INVITATION_SENT: "Invitación enviada correctamente.",
  STUDENT_INVITATION_RESENT: "Invitación reenviada correctamente.",
  STUDENT_INVITATION_REVOKED: "Invitación revocada correctamente.",
  STUDENT_ENROLLMENT_COMPLETED: "Perfil de estudiante completado correctamente.",
  STUDENT_PHONE_UPDATED: "Teléfono actualizado correctamente.",
} as const

export const STUDENT_ENROLLMENT_MESSAGES = {
  ACTIVE_BRANCH_REQUIRED: "La sucursal debe estar activa para enviar una invitación.",
  ADMIN_ONLY: "Solo los administradores de la sucursal pueden gestionar invitaciones.",
  CREATE_ACTION: "Enviar invitación",
  DATE_OF_BIRTH_LABEL: "Fecha de nacimiento",
  EMAIL_LABEL: "Correo electrónico",
  ENROLLMENT_DESCRIPTION: "Complete sus datos para activar su perfil de estudiante.",
  ENROLLMENT_SAVE_FAILURE: "No se pudo completar el perfil de estudiante. Inténtelo nuevamente.",
  ENROLLMENT_TITLE: "Complete su perfil",
  EXPIRES_AT: "Vence",
  FIRST_NAME_LABEL: "Nombre",
  INACTIVE_READ_ONLY: "Su perfil está inactivo y solo puede consultarlo.",
  INVITATION_ALREADY_ACCEPTED: "Esta invitación ya fue aceptada y no se puede modificar.",
  INVITATION_CONFIGURATION_REQUIRED: "La configuración de enlaces de invitación no está disponible.",
  INVITATION_DELIVERY_FAILURE: "No se pudo enviar la invitación. Inténtelo nuevamente.",
  INVITATION_EXPIRED: "Esta invitación venció. Solicite a la administración un nuevo enlace.",
  INVITATION_LOAD_FAILURE: "No se pudieron cargar las invitaciones. Inténtelo nuevamente.",
  INVITATION_REQUIRES_REVIEW: "Esta invitación requiere revisión administrativa antes de reenviarse.",
  INVITATION_REVOKED: "Esta invitación fue revocada. Contacte a la administración.",
  INVITATION_SAVE_FAILURE: "No se pudo guardar la invitación. Inténtelo nuevamente.",
  INVITATION_UNAVAILABLE: "No hay una invitación de estudiante disponible para esta cuenta.",
  INVALID_BRANCH_ID: "El identificador de la sucursal no es válido.",
  INVALID_EMAIL: "El correo electrónico no es válido.",
  INVITATIONS_DESCRIPTION: "Envíe y gestione invitaciones de autoservicio para estudiantes de esta sucursal.",
  INVITATIONS_EMPTY: "No hay invitaciones para esta sucursal.",
  INVITATIONS_TABLE_CAPTION: "Invitaciones de estudiantes",
  INVITATIONS_TITLE: "Invitaciones de estudiantes",
  NEEDS_REVIEW: "No se pudo completar la inscripción. La administración revisará el caso sin compartir detalles personales.",
  NATIONAL_ID_LABEL: "Cédula",
  PASSWORD_DESCRIPTION: "Defina una contraseña para continuar con el registro.",
  PASSWORD_LABEL: "Nueva contraseña",
  PASSWORD_MIN_LENGTH: "La contraseña debe tener al menos 8 caracteres.",
  PASSWORD_REQUIRED: "Defina una contraseña antes de completar su perfil.",
  PASSWORD_SAVE_FAILURE: "No se pudo actualizar la contraseña. Inténtelo nuevamente.",
  PASSWORD_TITLE: "Defina su contraseña",
  ...
  PROFILE_EMAIL_DESCRIPTION: "El correo proviene de su invitación y no se puede modificar.",
  PROFILE_TITLE: "Mi perfil",
  RESEND_ACTION: "Reenviar",
  REVOKE_ACTION: "Revocar",
  STATE_ACCEPTED: "Aceptada",
  STATE_EXPIRED: "Vencida",
  STATE_NEEDS_REVIEW: "Requiere revisión",
